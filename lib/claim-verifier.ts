...
//   provider: "reality-defender" | "local-model" | "heuristics";
//   is_tampered: boolean | null; // null if no image
//   tampering_score: number | null; // 0–1 or 0–100
...
//   image_verification?: ImageVerificationResult; // <--- new
// }
...
// claim-verifier.tsx
// Complete claim verification system with Transformers.js + MCP + image authenticity
// Deploy to Vercel as an API route or standalone service
